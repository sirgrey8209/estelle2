...
function useRelayConnection() {
  const { setConnected, setAuthenticated, setDeviceId, setDesksLoaded } = useRelayStore();
  const wsRef = useRef<WebSocket | null>(null);

  const handleMessage = useCallback((message: RelayMessage) => {
  ...
  useEffect(() => {
    ...
    const wsUrl = __DEV__ ? RelayConfig.localUrl : RelayConfig.url;
